...
func (s *ServiceInfoHolder) RegisterCallback(serviceName string, clusters string, callbackFunc *func(service string, services []model.Instance, err error)) {
	s.subCallback.AddCallbackFunc(serviceName, clusters, callbackFunc)
}

func (s *ServiceInfoHolder) DeregisterCallback(serviceName string, clusters string, callbackFunc *func(service string, services []model.Instance, err error)) {
